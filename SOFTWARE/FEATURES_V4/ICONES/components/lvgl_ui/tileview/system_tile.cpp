...
void system_tile_init(lv_obj_t *parent)
{
    ...
    lv_obj_align(label_batt_pct, LV_ALIGN_TOP_RIGHT, -60, 12);
    lv_obj_set_style_text_font(label_batt_pct, &lv_font_montserrat_16, 0);


    // Icona WiFi
    icon_wifi = lv_img_create(parent);
    lv_obj_align(icon_wifi, LV_ALIGN_TOP_RIGHT, -10, 55);
/*
