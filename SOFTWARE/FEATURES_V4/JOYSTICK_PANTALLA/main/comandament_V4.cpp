...
extern "C" void app_main(void)
{
   // Inicialització de NVS (memòria no volàtil)
    ...
    // Inicialitzar botó GPIO20 amb pull-up intern
...
void i2c_bus_init(void)
{
    ...
    i2c_mst_config.flags.enable_internal_pullup = 1;    // Activa resistències pull-up internes. Accepta pull-up externes si cal, (si hi ha problemes amb SD o Touch comprova si calen pull-ups externes, molts perifèrics I2C funcionen millor amb pullúp externes)
